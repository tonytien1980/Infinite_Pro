...
class SalesBusinessDevelopmentAgent(CoreAnalysisAgent):
    ...
    def run(self, payload: AgentInputPayload) -> CoreAgentResult:
        ...
        return CoreAgentResult(
            ...
            risks=[
                RiskDraft(
                    title=f"Sales / business development risk {index + 1}",
                    description=item,
            ...
            recommendations=[
                RecommendationDraft(
                    summary=item,
                    rationale="Generated by the Sales / Business Development Agent using the model router.",
