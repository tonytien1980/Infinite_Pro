...
class MarketingGrowthAgent(CoreAnalysisAgent):
    ...
    def run(self, payload: AgentInputPayload) -> CoreAgentResult:
        ...
        return CoreAgentResult(
            ...
            risks=[
                RiskDraft(
                    title=f"Marketing / growth risk {index + 1}",
                    description=item,
                    risk_type="growth",
                    impact_level="medium",
            ...
            recommendations=[
                RecommendationDraft(
                    summary=item,
                    rationale="Generated by the Marketing / Growth Agent using the model router.",
