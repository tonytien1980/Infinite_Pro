...
- 尚未把最強的 2 到 3 類旗艦顧問案型清楚產品化
- `Research / Investigation` 尚未成為一條成熟、明確、可清楚選擇深度的 high-value lane
- `follow_up / continuous` 已有正式 baseline，但尚未完全產品化為 retained advisory experience
