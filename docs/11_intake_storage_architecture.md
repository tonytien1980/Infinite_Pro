...
### 4.6 Object-set downstream scope boundary
Wave 5 之後，intake / supplement / parse 主鏈仍不應被誤解成 object-set workflow。

正式規則：
- `ObjectSet` 不是新的 intake mode
- system 可在 intake 後、evidence / deliverable / task aggregates 已形成時，正式收斂：
